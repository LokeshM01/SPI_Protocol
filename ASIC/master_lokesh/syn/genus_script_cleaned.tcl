...
set BASEDIR "../presyn"
set OUTDIR "."
set VERILOG_IN1 $BASEDIR/master.v
set VERILOG_OUT $OUTDIR/master_syn.v
set SDF_OUT $OUTDIR/master_syn.sdf
set SDC_OUT $OUTDIR/master_syn.sdc
...
get_db [get_designs master] .tns
# set_max_fanout 20 [get_designs master]
set_max_transition 0.6 [get_designs master]
syn_gen
syn_map
syn_opt -incr
report timing
write_sdf -version "OVI 2.1" -design master -precision 4 -edges check_edge -setuphold merge_when_paired -recrem split -nonegchecks > $SDF_OUT
write_sdc > $SDC_OUT
write_hdl > $VERILOG_OUT
write_db  -to_file master_syn.db
# power analysis
read_netlist master_syn.v
