...
# Generated on: Fri Nov 14 22:59:34 IST 2025 (Fri Nov 14 17:29:34 UTC 2025)
...
set logfile fv/master/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/master -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/cad/tools/cadence/GENUS/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/cad/tools/cadence/GENUS/GENUS211/tools.lnx86"
set env(CW_DIR) "/cad/tools/cadence/GENUS/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/cad/tools/cadence/GENUS/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /cad/tools/cadence/GENUS/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/cad/tools/cadence/GENUS/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/cad/tools/cadence/GENUS/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/cad/tools/cadence/GENUS/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/cad/tools/cadence/GENUS/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
add_search_path /cad/TechLib/TSMC65/tcbn65gplus_200a/TSMCHOME/digital/Front_End/timing_power_noise/CCS/tcbn65gplus_200a -library -both
read_library -liberty -both \
    /cad/TechLib/TSMC65/tcbn65gplus_200a/TSMCHOME/digital/Front_End/timing_power_noise/CCS/tcbn65gplus_200a/tcbn65gpluswc_ccs.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../presyn/master.v
elaborate_design -golden -root {master} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/master/fv_map.v.gz
elaborate_design -revised -root {master}
...
#add_name_alias fv/master/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.master.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.master.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.master.rtl.fv_map.rpt
