...
# Generated on: Fri Nov 14 18:29:30 IST 2025 (Fri Nov 14 12:59:30 UTC 2025)
...
set logfile fv/slave/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/slave -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../presyn/slave.v
elaborate_design -golden -root {slave} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/slave/fv_map.v.gz
elaborate_design -revised -root {slave}
...
#add_name_alias fv/slave/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.slave.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.slave.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.slave.rtl.fv_map.rpt
